...
public class SURF extends Feature2D {
     ...
     * 创建SURF检测器
     *
     * @param hessianThreshold  关键点寻找步骤使用的Hessian矩阵阈值，默认值为100
     * @param nOctaves  级联的数目，相当于图像金字塔的层级，一般是4
     * @param nOctaveLayers 每个级联有多少层，最少不小于3
     * @param extended  默认是16个向量，64个描述子，如果为true，则每个关键点为128个描述子
     * @param upright   是否使用U-SURF方法，默认是false，不使用
     * @return
     */
